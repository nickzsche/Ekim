module.exports = [
"[project]/teklif-formu/.next-internal/server/app/api/projects/[id]/items/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/teklif-formu/src/app/api/projects/[id]/items/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        const { group_id, product_id, product_name, quantity, unit_price, discount, margin, sales_price, square_meters } = body;
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(projectId, group_id || null, product_id, product_name, quantity || 1, unit_price || 0, discount || 0, margin || 0, sales_price || 0, square_meters || 0);
        const newItem = db.prepare('SELECT * FROM project_items WHERE id = ?').get(result.lastInsertRowid);
        return __TURBOPACK__imported__module__$5b$project$5d2f$teklif$2d$formu$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newItem);
    } catch (error) {
...
async function PUT(request, { params }) {
    try {
        ...
        if (items && Array.isArray(items)) {
            ...
            groupRows.forEach((g)=>groupMap.set(g.name, g.id));
          ...
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(projectId, groupId || null, item.product_id, item.product_name, item.quantity || 1, item.unit_price || 0, item.discount || 0, item.margin || 0, item.sales_price || 0, item.square_meters || 0, i);
            }
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$teklif$2d$formu$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Proje ürünleri güncellendi'
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__475bc318._.js.map