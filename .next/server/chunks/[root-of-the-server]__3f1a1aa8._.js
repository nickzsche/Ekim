module.exports = [
"[project]/teklif-formu/.next-internal/server/app/api/suppliers/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/teklif-formu/src/app/api/suppliers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$teklif$2d$formu$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(suppliers);
    } catch (error) {
...
async function POST(request) {
    try {
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).run(data.name, data.description || null, data.contact_name || null, data.email || null, data.phone || null, data.address || null);
        const supplier = db.prepare('SELECT * FROM suppliers WHERE id = ?').get(result.lastInsertRowid);
        return __TURBOPACK__imported__module__$5b$project$5d2f$teklif$2d$formu$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(supplier, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3f1a1aa8._.js.map