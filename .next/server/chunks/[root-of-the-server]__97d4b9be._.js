module.exports = [
"[project]/teklif-formu/.next-internal/server/app/api/quotes/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/teklif-formu/src/app/api/quotes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    `).all();
        return __TURBOPACK__imported__module__$5b$project$5d2f$teklif$2d$formu$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(quotes);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `);
            const result = quoteStmt.run(quote.customer_name, quote.customer_email || null, quote.customer_phone || null, quote.company || null, quote.total_amount || 0, quote.status || 'draft', quote.notes || null);
        ...
        `);
                ...
                for (const item of items){
                    ...
                    itemStmt.run(quoteId, item.product_id, item.quantity, item.unit_price, itemTotal);
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__97d4b9be._.js.map