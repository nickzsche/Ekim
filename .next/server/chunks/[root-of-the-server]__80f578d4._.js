...
async function POST(request) {
    try {
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `);
        const result = stmt.run(product.name, product.code || null, product.brand || null, product.model || null, product.category || null, product.price || null, product.description || null, product.specifications || null, product.stock_quantity || 0, product.unit || 'adet', product.supplier_id || null);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__80f578d4._.js.map