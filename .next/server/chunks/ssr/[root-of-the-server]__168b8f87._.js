      ...
      <div class="project-details">
        ...
        <div class="project-info-grid">
          ...
          <div class="info-item">
            ...
            <div class="info-value">${data.schedule.startDate ? new Date(data.schedule.startDate).toLocaleDateString('tr-TR', {
        day: '2-digit',
        month: 'long',
        year: 'numeric'
    }) : '-'}</div>
          ...
          <div class="info-item">
            ...
            <div class="info-value">${data.schedule.endDate ? new Date(data.schedule.endDate).toLocaleDateString('tr-TR', {
        day: '2-digit',
        month: 'long',
        year: 'numeric'
    }) : '-'}</div>
      ...
      <div>
          ...
          <tbody>
            ${data.items.map((item, index)=>`
              <tr>
                ...
                <td style="text-align: right; font-weight: 600; color: #059669;">€${item.unitPrice.toLocaleString('tr-TR', {
            minimumFractionDigits: 2
        })}</td>
                <td style="text-align: right; font-weight: 700; color: #1e293b; font-size: 14px;">€${item.total.toLocaleString('tr-TR', {
            minimumFractionDigits: 2
        })}</td>
              </tr>
            `).join('')}
        ...
        <div class="total-section">
          <div class="total-row subtotal">
            ...
            <span>€${data.items.reduce((sum, item)=>sum + item.total, 0).toLocaleString('tr-TR', {
        minimumFractionDigits: 2
    })}</span>
          </div>
          <div class="total-row">
            <strong>KDV (%20)</strong>
            <span>€${(data.items.reduce((sum, item)=>sum + item.total, 0) * 0.2).toLocaleString('tr-TR', {
        minimumFractionDigits: 2
    })}</span>
          </div>
          <div class="total-row grand-total">
            <strong>GENEL TOPLAM</strong>
            <span>€${(data.items.reduce((sum, item)=>sum + item.total, 0) * 1.2).toLocaleString('tr-TR', {
        minimumFractionDigits: 2
    })}</span>
          </div>
        </div>
