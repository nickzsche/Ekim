...
<body>
  ...
  <div class="container">
    ...
    <div class="project-details">
      ...
      <table class="project-info-table">
        ...
        <tr>
          ...
          <td style="font-weight: 600; color: #059669;">${data.schedule.startDate ? new Date(data.schedule.startDate).toLocaleDateString('tr-TR', {
        day: '2-digit',
        month: 'long',
        year: 'numeric'
    }) : '-'}</td>
          <td><strong>🏁 Bitiş Tarihi:</strong></td>
          <td style="font-weight: 600; color: #059669;">${data.schedule.endDate ? new Date(data.schedule.endDate).toLocaleDateString('tr-TR', {
        day: '2-digit',
        month: 'long',
        year: 'numeric'
    }) : '-'}</td>
    ...
    <div>
        ...
        <tbody>
          ${data.items.map((item, index)=>`
            <tr>
              ...
              <td style="text-align: right; font-weight: 700; color: #059669; vertical-align: middle;">€${item.unitPrice.toLocaleString('tr-TR', {
            minimumFractionDigits: 2
        })}</td>
              <td style="text-align: right; font-weight: 800; color: #dc2626; vertical-align: middle;">€${item.total.toLocaleString('tr-TR', {
            minimumFractionDigits: 2
        })}</td>
            </tr>
          `).join('')}
      ...
      <div class="total-box">
        <div style="margin-bottom: 8px;">Ara Toplam: €${data.items.reduce((sum, item)=>sum + item.total, 0).toLocaleString('tr-TR', {
        minimumFractionDigits: 2
    })}</div>
        <div style="font-size: 13px;">KDV (%20) Dahil Toplam: <span style="color:#dc2626;">€${(data.items.reduce((sum, item)=>sum + item.total, 0) * 1.2).toLocaleString('tr-TR', {
        minimumFractionDigits: 2
    })}</span></div>
      </div>
...
//# sourceMappingURL=%5Broot-of-the-server%5D__168b8f87._.js.map