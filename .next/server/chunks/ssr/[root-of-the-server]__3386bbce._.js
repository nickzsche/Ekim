      ...
      <tbody>
        ${data.items.map((item, index)=>`
          <tr style="background: ${index % 2 === 0 ? '#f8fafc' : 'white'};">
            ...
            <td style="padding: 10px; text-align: right; font-size: 11px; font-weight: 700; color: #059669; border: 1px solid #e5e7eb; vertical-align: middle;">€${item.unitPrice.toLocaleString('tr-TR', {
                minimumFractionDigits: 2
            })}</td>
            <td style="padding: 10px; text-align: right; font-size: 11px; font-weight: 800; color: #dc2626; border: 1px solid #e5e7eb; vertical-align: middle;">€${item.total.toLocaleString('tr-TR', {
                minimumFractionDigits: 2
            })}</td>
          </tr>
        `).join('')}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3386bbce._.js.map