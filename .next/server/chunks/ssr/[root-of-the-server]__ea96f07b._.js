    ...
    <table style="width: 100%; border-collapse: collapse;">
      <tr>
        ...
        <td style="width: 50%; vertical-align: top; text-align: right;">
          ...
          <div style="background: #ffffff; padding: 20px; border-radius: 8px; display: inline-block; text-align: left; min-width: 260px; border: 4px solid #1e40af; box-shadow: 0 4px 6px rgba(0,0,0,0.2);">
            <div style="font-size: 16px; font-weight: 800; color: #1e40af; margin-bottom: 10px; line-height: 1.5; border-bottom: 2px solid #93c5fd; padding-bottom: 8px;">
              👤 ${data.customerInfo.name || 'Müşteri adı girilmemiş'}
            </div>
            ${data.customerInfo.company ? `<div style="font-size: 13px; color: #1e293b; font-weight: 700; margin-bottom: 8px; line-height: 1.5;">🏢 ${data.customerInfo.company}</div>` : ''}
            ${data.customerInfo.phone ? `<div style="font-size: 12px; color: #334155; font-weight: 600; margin-top: 6px; line-height: 1.5;">� ${data.customerInfo.phone}</div>` : ''}
            ${data.customerInfo.email ? `<div style="font-size: 11px; margin-top: 4px; color: #475569; line-height: 1.5;">� ${data.customerInfo.email}</div>` : ''}
          </div>
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ea96f07b._.js.map