module.exports = [
"[project]/.next-internal/server/app/api/suppliers/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/suppliers/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
      ...
      WHERE id = ?
    `).run(data.name, data.description || null, data.contact_name || null, data.email || null, data.phone || null, data.address || null, params.id);
        const supplier = db.prepare('SELECT * FROM suppliers WHERE id = ?').get(params.id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(supplier);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__284baaef._.js.map