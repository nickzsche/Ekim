module.exports = [
"[project]/teklif-formu/.next-internal/server/app/api/customers/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/teklif-formu/src/app/api/customers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$teklif$2d$formu$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(customers);
    } catch (error) {
...
async function POST(request) {
    try {
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    `);
        const result = stmt.run(customer.name, customer.email || null, customer.phone || null, customer.company || null, customer.address || null, customer.tax_number || null, customer.tax_office || null, customer.balance || 0);
        const newCustomer = db.prepare('SELECT * FROM customers WHERE id = ?').get(result.lastInsertRowid);
        return __TURBOPACK__imported__module__$5b$project$5d2f$teklif$2d$formu$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newCustomer);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c986f858._.js.map